...
namespace REX
{
	...
	[[nodiscard]] auto ThreadPool::SubmitTaskRange(It a_begin, It a_end, const F& a_func, const Args&... a_args) // NOLINT(cppcoreguidelines-missing-std-forward)
	...
	[[nodiscard]] auto ThreadPool::SubmitTaskRange(Range& a_range, const F& a_func, const Args&... a_args)
					 ...
					 ...))
	{
		...
		return SubmitTaskRange(begin, end, a_func, a_args...);
	}

	template <std::ranges::forward_range Range, class F, class... Args>
	[[nodiscard]] auto ThreadPool::SubmitTaskRange(const Range& a_range, const F& a_func, const Args&... a_args)
	...
	template <std::ranges::forward_range Range, class F, class... Args>
	[[nodiscard]] auto ThreadPool::SubmitTaskRange(Range&& a_range, const F& a_func, const Args&... a_args) // NOLINT(cppcoreguidelines-missing-std-forward)
