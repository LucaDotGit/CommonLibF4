...
namespace REX::W32
{
	...
	inline constexpr auto D3D11_COMMONSHADER_TEMP_REGISTER_COUNT{ 0x1000 };
	...
	inline constexpr auto D3D11_CS_DISPATCH_MAX_THREAD_GROUPS_PER_DIMENSION{ 0xFFFF };

	inline constexpr auto D3D11_CS_TGSM_REGISTER_COUNT{ 0x2000 };
	...
	inline constexpr auto D3D11_CS_THREAD_GROUP_MAX_THREADS_PER_GROUP{ 0x400 };

	inline constexpr auto D3D11_CS_THREAD_GROUP_MAX_X{ 0x400 };
	inline constexpr auto D3D11_CS_THREAD_GROUP_MAX_Y{ 0x400 };
	...
	inline constexpr auto D3D11_CS_THREAD_LOCAL_TEMP_REGISTER_POOL{ 0x4000 };

	inline constexpr auto D3D11_DEFAULT_BLEND_FACTOR_ALPHA{ 1.0_f32 };
	inline constexpr auto D3D11_DEFAULT_BLEND_FACTOR_BLUE{ 1.0_f32 };
	inline constexpr auto D3D11_DEFAULT_BLEND_FACTOR_GREEN{ 1.0_f32 };
	inline constexpr auto D3D11_DEFAULT_BLEND_FACTOR_RED{ 1.0_f32 };

	inline constexpr auto D3D11_DEFAULT_BORDER_COLOR_COMPONENT{ 0.0_f32 };

	inline constexpr auto D3D11_DEFAULT_DEPTH_BIAS{ 0 };
	inline constexpr auto D3D11_DEFAULT_DEPTH_BIAS_CLAMP{ 0.0_f32 };

	inline constexpr auto D3D11_DEFAULT_MAX_ANISOTROPY{ 16 };

	inline constexpr auto D3D11_DEFAULT_MIP_LOD_BIAS{ 0.0_f32 };
	...
	inline constexpr auto D3D11_DEFAULT_SLOPE_SCALED_DEPTH_BIAS{ 0.0_f32 };
	...
	inline constexpr auto D3D11_DEFAULT_VIEWPORT_MAX_DEPTH{ 0.0_f32 };
	inline constexpr auto D3D11_DEFAULT_VIEWPORT_MIN_DEPTH{ 0.0_f32 };
	...
	inline constexpr auto D3D11_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP{ 0.6_f32 };

	inline constexpr auto D3D11_FLOAT_TO_SRGB_EXPONENT_DENOMINATOR{ 2.4_f32 };
	inline constexpr auto D3D11_FLOAT_TO_SRGB_EXPONENT_NUMERATOR{ 1.0_f32 };
	inline constexpr auto D3D11_FLOAT_TO_SRGB_OFFSET{ 0.055_f32 };
	inline constexpr auto D3D11_FLOAT_TO_SRGB_SCALE_1{ 12.92_f32 };
	inline constexpr auto D3D11_FLOAT_TO_SRGB_SCALE_2{ 1.055_f32 };
	inline constexpr auto D3D11_FLOAT_TO_SRGB_THRESHOLD{ 0.0031308_f32 };

	inline constexpr auto D3D11_FTOI_INSTRUCTION_MAX_INPUT{ 2147483647.999_f32 };
	inline constexpr auto D3D11_FTOI_INSTRUCTION_MIN_INPUT{ -2147483648.999_f32 };

	inline constexpr auto D3D11_FTOU_INSTRUCTION_MAX_INPUT{ 4294967295.999_f32 };
	inline constexpr auto D3D11_FTOU_INSTRUCTION_MIN_INPUT{ 0.0_f32 };
	...
	inline constexpr auto D3D11_GS_MAX_OUTPUT_VERTEX_COUNT_ACROSS_INSTANCES{ 0x400 };
	...
	inline constexpr auto D3D11_HS_MAXTESSFACTOR_LOWER_BOUND{ 1.0_f32 };
	inline constexpr auto D3D11_HS_MAXTESSFACTOR_UPPER_BOUND{ 64.0_f32 };
	...
	inline constexpr auto D3D11_LINEAR_GAMMA{ 1.0_f32 };

	inline constexpr auto D3D11_MAJOR_VERSION{ 11 };

	inline constexpr auto D3D11_MAX_BORDER_COLOR_COMPONENT{ 1.0_f32 };
	inline constexpr auto D3D11_MAX_DEPTH{ 1.0_f32 };
	...
	inline constexpr auto D3D11_MIN_BORDER_COLOR_COMPONENT{ 0.0_f32 };
	inline constexpr auto D3D11_MIN_DEPTH{ 0.0_f32 };
	inline constexpr auto D3D11_MIN_MAXANISOTROPY{ 0 };

	inline constexpr auto D3D11_MIP_LOD_BIAS_MAX{ 15.99_f32 };
	inline constexpr auto D3D11_MIP_LOD_BIAS_MIN{ -16.0_f32 };
	inline constexpr auto D3D11_MIP_LOD_FRACTIONAL_BIT_COUNT{ 8 };

	inline constexpr auto D3D11_MIP_LOD_RANGE_BIT_COUNT{ 8 };

	inline constexpr auto D3D11_MULTISAMPLE_ANTIALIAS_LINE_WIDTH{ 1.4_f32 };
	...
	inline constexpr auto D3D11_PS_LEGACY_PIXEL_CENTER_FRACTIONAL_COMPONENT{ 0.0_f32 };
	...
	inline constexpr auto D3D11_PS_PIXEL_CENTER_FRACTIONAL_COMPONENT{ 0.5_f32 };
	inline constexpr auto D3D11_RAW_UAV_SRV_BYTE_ALIGNMENT{ 16 };

	inline constexpr auto D3D11_REQ_BLEND_OBJECT_COUNT_PER_DEVICE{ 0x1000 };

	inline constexpr auto D3D11_REQ_BUFFER_RESOURCE_TEXEL_COUNT_2_TO_EXP{ 27 };

	inline constexpr auto D3D11_REQ_CONSTANT_BUFFER_ELEMENT_COUNT{ 0x1000 };

	inline constexpr auto D3D11_REQ_DEPTH_STENCIL_OBJECT_COUNT_PER_DEVICE{ 0x1000 };
	...
	inline constexpr auto D3D11_REQ_FILTERING_HW_ADDRESSABLE_RESOURCE_DIMENSION{ 0x4000 };

	inline constexpr auto D3D11_REQ_GS_INVOCATION_32BIT_OUTPUT_COMPONENT_LIMIT{ 0x400 };

	inline constexpr auto D3D11_REQ_IMMEDIATE_CONSTANT_BUFFER_ELEMENT_COUNT{ 0x1000 };

	inline constexpr auto D3D11_REQ_MAXANISOTROPY{ 16 };

	inline constexpr auto D3D11_REQ_MIP_LEVELS{ 15 };

	inline constexpr auto D3D11_REQ_MULTI_ELEMENT_STRUCTURE_SIZE_IN_BYTES{ 0x800 };

	inline constexpr auto D3D11_REQ_RASTERIZER_OBJECT_COUNT_PER_DEVICE{ 0x1000 };

	inline constexpr auto D3D11_REQ_RENDER_TO_BUFFER_WINDOW_WIDTH{ 0x4000 };

	inline constexpr auto D3D11_REQ_RESOURCE_SIZE_IN_MEGABYTES_EXPRESSION_A_TERM{ 128 };
	inline constexpr auto D3D11_REQ_RESOURCE_SIZE_IN_MEGABYTES_EXPRESSION_B_TERM{ 0.25_f32 };
	inline constexpr auto D3D11_REQ_RESOURCE_SIZE_IN_MEGABYTES_EXPRESSION_C_TERM{ 0x800 };

	inline constexpr auto D3D11_REQ_RESOURCE_VIEW_COUNT_PER_DEVICE_2_TO_EXP{ 20 };

	inline constexpr auto D3D11_REQ_SAMPLER_OBJECT_COUNT_PER_DEVICE{ 0x1000 };

	inline constexpr auto D3D11_REQ_TEXTURE1D_ARRAY_AXIS_DIMENSION{ 0x800 };
	inline constexpr auto D3D11_REQ_TEXTURE1D_U_DIMENSION{ 0x4000 };
	inline constexpr auto D3D11_REQ_TEXTURE2D_ARRAY_AXIS_DIMENSION{ 0x800 };
	inline constexpr auto D3D11_REQ_TEXTURE2D_U_OR_V_DIMENSION{ 0x4000 };
	inline constexpr auto D3D11_REQ_TEXTURE3D_U_V_OR_W_DIMENSION{ 0x800 };

	inline constexpr auto D3D11_REQ_TEXTURECUBE_DIMENSION{ 0x4000 };
	...
	inline constexpr auto D3D11_SHADER_MAX_INSTANCES{ 0xFFFF };
	inline constexpr auto D3D11_SHADER_MAX_INTERFACES{ 253 };
	inline constexpr auto D3D11_SHADER_MAX_INTERFACE_CALL_SITES{ 0x1000 };
	inline constexpr auto D3D11_SHADER_MAX_TYPES{ 0xFFFF };
	...
	inline constexpr auto D3D11_SO_BUFFER_MAX_STRIDE_IN_BYTES{ 0x800 };
	inline constexpr auto D3D11_SO_BUFFER_MAX_WRITE_WINDOW_IN_BYTES{ 0x200 };
	...
	inline constexpr auto D3D11_SRGB_GAMMA{ 2.2_f32 };
	inline constexpr auto D3D11_SRGB_TO_FLOAT_DENOMINATOR_1{ 12.92_f32 };
	inline constexpr auto D3D11_SRGB_TO_FLOAT_DENOMINATOR_2{ 1.055_f32 };
	inline constexpr auto D3D11_SRGB_TO_FLOAT_EXPONENT{ 2.4_f32 };
	inline constexpr auto D3D11_SRGB_TO_FLOAT_OFFSET{ 0.055_f32 };
	inline constexpr auto D3D11_SRGB_TO_FLOAT_THRESHOLD{ 0.04045_f32 };
	inline constexpr auto D3D11_SRGB_TO_FLOAT_TOLERANCE_IN_ULP{ 0.5_f32 };
	...
	inline constexpr auto D3D11_VIEWPORT_BOUNDS_MAX{ 0x7FFF };
	inline constexpr auto D3D11_VIEWPORT_BOUNDS_MIN{ -0x7FFF };
...
namespace REX::W32
{
	enum D3D11_ASYNC_GETDATA_FLAG : std::uint32_t
	{
		D3D11_ASYNC_GETDATA_DONOTFLUSH = 0x1
	};

	enum D3D11_AUTHENTICATED_CHANNEL_TYPE : std::int32_t
	{
	...
	enum D3D11_BIND_FLAG : std::uint32_t
	{
	...
	enum D3D11_BLEND_OP : std::int32_t
	{
	...
	enum D3D11_BUFFER_UAV_FLAG : std::uint32_t
	{
	...
	enum D3D11_BUFFEREX_SRV_FLAG : std::uint32_t
	{
		D3D11_BUFFEREX_SRV_FLAG_RAW = 0x1
	};

	enum D3D11_CLEAR_FLAG : std::uint32_t
	{
		D3D11_CLEAR_DEPTH = 0x1,
		D3D11_CLEAR_STENCIL = 0x2
	};

	enum D3D11_COLOR_WRITE_ENABLE : std::int32_t
	{
	...
	enum D3D11_COMPARISON_FUNC : std::int32_t
	{
	...
	enum D3D11_CONTENT_PROTECTION_CAPS : std::int32_t
	{
	...
	enum D3D11_COUNTER : std::int32_t
	{
		D3D11_COUNTER_DEVICE_DEPENDENT_0 = 0x40000000
	};

	enum D3D11_COUNTER_TYPE : std::int32_t
	{
	...
	enum D3D11_CPU_ACCESS_FLAG : std::uint32_t
	{
		D3D11_CPU_ACCESS_WRITE = 0x10000,
		D3D11_CPU_ACCESS_READ = 0x20000
	};

	enum D3D11_CREATE_DEVICE_FLAG : std::uint32_t
	{
	...
	enum D3D11_CULL_MODE : std::int32_t
	{
		D3D11_CULL_NONE = 1,
		D3D11_CULL_FRONT = 2,
		D3D11_CULL_BACK = 3
	...
	enum D3D11_DEPTH_WRITE_MASK : std::int32_t
	{
		D3D11_DEPTH_WRITE_MASK_ZERO = 0,
		D3D11_DEPTH_WRITE_MASK_ALL = 1
	};

	enum D3D11_DEVICE_CONTEXT_TYPE : std::int32_t
	{
		D3D11_DEVICE_CONTEXT_IMMEDIATE = 0,
		D3D11_DEVICE_CONTEXT_DEFERRED = 1
	};

	enum D3D11_DSV_DIMENSION : std::int32_t
	{
	...
	enum D3D11_DSV_FLAG : std::uint32_t
	{
		D3D11_DSV_READ_ONLY_DEPTH = 0x1,
		D3D11_DSV_READ_ONLY_STENCIL = 0x2
	};

	enum D3D11_FEATURE : std::int32_t
	{
	...
	enum D3D11_FILL_MODE : std::int32_t
	{
		D3D11_FILL_WIREFRAME = 2,
		D3D11_FILL_SOLID = 3
	};

	enum D3D11_FILTER : std::int32_t
	{
	...
	enum D3D11_FILTER_TYPE : std::int32_t
	{
		D3D11_FILTER_TYPE_POINT = 0,
		D3D11_FILTER_TYPE_LINEAR = 1
	};

	enum D3D11_FILTER_REDUCTION_TYPE : std::int32_t
	{
	...
	enum D3D11_FORMAT_SUPPORT : std::int32_t
	{
	...
	enum D3D11_FORMAT_SUPPORT2 : std::int32_t
	{
	...
	enum D3D11_INPUT_CLASSIFICATION : std::int32_t
	{
		D3D11_INPUT_PER_VERTEX_DATA = 0,
		D3D11_INPUT_PER_INSTANCE_DATA = 1
	};

	enum D3D11_MAP : std::int32_t
	{
		D3D11_MAP_READ = 1,
		D3D11_MAP_WRITE = 2,
	...
	enum D3D11_MAP_FLAG : std::uint32_t
	{
	...
	enum D3D11_QUERY_MISC_FLAG : std::uint32_t
	{
		D3D11_QUERY_MISC_PREDICATEHINT = 0x1
	};

	enum D3D11_RAISE_FLAG : std::uint32_t
	{
		D3D11_RAISE_FLAG_DRIVER_INTERNAL_ERROR = 0x1
	};

	enum D3D11_RESOURCE_DIMENSION : std::int32_t
	{
	...
	enum D3D11_RESOURCE_MISC_FLAG : std::uint32_t
	{
	...
	enum D3D11_RTV_DIMENSION : std::int32_t
	{
	...
	enum D3D11_STANDARD_MULTISAMPLE_QUALITY_LEVELS : std::int32_t
	{
		D3D11_STANDARD_MULTISAMPLE_PATTERN = -1,
		D3D11_CENTER_MULTISAMPLE_PATTERN = -1
	};

	enum D3D11_STENCIL_OP : std::int32_t
	{
	...
	enum D3D11_TEXTURE_ADDRESS_MODE : std::int32_t
	{
	...
	enum D3D11_TEXTURECUBE_FACE : std::int32_t
	{
	...
	enum D3D11_UAV_DIMENSION : std::int32_t
	{
	...
	enum D3D11_VDOV_DIMENSION : std::int32_t
	{
		D3D11_VDOV_DIMENSION_UNKNOWN = 0,
		D3D11_VDOV_DIMENSION_TEXTURE2D = 1
	};

	enum D3D11_VPIV_DIMENSION : std::int32_t
	{
		D3D11_VPIV_DIMENSION_UNKNOWN = 0,
		D3D11_VPIV_DIMENSION_TEXTURE2D = 1
	};

	enum D3D11_VPOV_DIMENSION : std::int32_t
	{
	...
	enum D3D11_VIDEO_DECODER_BUFFER_TYPE : std::int32_t
	{
	...
	enum D3D11_VIDEO_FRAME_FORMAT : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_AUTO_STREAM_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_DEVICE_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_FEATURE_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_FILTER : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_FILTER_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_FORMAT_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_FORMAT_SUPPORT : std::int32_t
	{
		D3D11_VIDEO_PROCESSOR_FORMAT_SUPPORT_INPUT = 0x1,
		D3D11_VIDEO_PROCESSOR_FORMAT_SUPPORT_OUTPUT = 0x2
	};

	enum D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS : std::int32_t
	{
		...
		D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS_OTHER = static_cast<std::underlying_type_t<D3D11_VIDEO_PROCESSOR_ITELECINE_CAPS>>(0x80000000)
	};

	enum D3D11_VIDEO_PROCESSOR_NOMINAL_RANGE : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_OUTPUT_RATE : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_PROCESSOR_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_ROTATION : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_STEREO_CAPS : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE : std::int32_t
	{
	...
	enum D3D11_VIDEO_PROCESSOR_STEREO_FORMAT : std::int32_t
	{
	...
	enum D3D11_VIDEO_USAGE : std::int32_t
	{
...
namespace REX::W32
{
	...
	struct D3D11_BLEND_DESC
	{
		...
		std::array<D3D11_RENDER_TARGET_BLEND_DESC, 8> renderTarget;
	};
	...
	struct D3D11_SAMPLER_DESC
	{
		...
		REX::Float32 mipLODBias;
		std::uint32_t maxAnisotropy;
		D3D11_COMPARISON_FUNC comparisonFunc;
		std::array<REX::Float32, 4> borderColor;
		REX::Float32 minLOD;
		REX::Float32 maxLOD;
	};
	...
	{
		REX::Float32 topLeftX;
		REX::Float32 topLeftY;
		REX::Float32 width;
		REX::Float32 height;
		REX::Float32 minDepth;
		REX::Float32 maxDepth;

		friend bool operator==(const D3D11_VIEWPORT& a_lhs, const D3D11_VIEWPORT& a_rhs)
		{
			return a_lhs.topLeftX == a_rhs.topLeftX && a_lhs.topLeftY == a_rhs.topLeftY && a_lhs.width == a_rhs.width && a_lhs.height == a_rhs.height && a_lhs.minDepth == a_rhs.minDepth && a_lhs.maxDepth == a_rhs.maxDepth;
		}
...
namespace REX::W32
{
		...
		: public IUnknown
	{
		...
		virtual std::uint32_t GetExceptionMode() = 0;
	};
		...
		: public ID3D11DeviceChild
	{
		...
		virtual void OMSetBlendState(ID3D11BlendState* a_blendState, std::array<const REX::Float32, 4> a_blendFactor, std::uint32_t a_sampleMask) = 0;
		...
		virtual void ClearRenderTargetView(ID3D11RenderTargetView* a_renderTargetView, std::array<const REX::Float32, 4> a_colorRGBA) = 0;
		virtual void ClearUnorderedAccessViewUint(ID3D11UnorderedAccessView* a_unorderedAccessView, std::array<std::uint32_t, 4> a_values) = 0;
		virtual void ClearUnorderedAccessViewFloat(ID3D11UnorderedAccessView* a_unorderedAccessView, std::array<const REX::Float32, 4> a_values) = 0;
		virtual void ClearDepthStencilView(ID3D11DepthStencilView* a_depthStencilView, std::uint32_t a_clearFlags, REX::Float32 a_depth, std::uint8_t a_stencil) = 0;
		virtual void GenerateMips(ID3D11ShaderResourceView* a_shaderResourceView) = 0;
		virtual void SetResourceMinLOD(ID3D11Resource* a_resource, REX::Float32 a_minLOD) = 0;
		virtual REX::Float32 GetResourceMinLOD(ID3D11Resource* a_resource) = 0;
		...
		virtual void OMGetBlendState(ID3D11BlendState** a_blendState, std::array<REX::Float32, 4> a_blendFactor, std::uint32_t* a_sampleMask) = 0;
		...
		virtual std::uint32_t GetContextFlags() = 0;
	...
	ID3D11Asynchronous
		: public ID3D11DeviceChild
	{
		virtual std::uint32_t GetDataSize() = 0;
	};
		...
		: public ID3D11DeviceChild
	{
		...
		virtual std::uint32_t GetEvictionPriority() = 0;
	};
		...
		: public ID3D11DeviceChild
	{
		...
		virtual void VideoProcessorSetStreamAlpha(ID3D11VideoProcessor* a_videoProcessor, std::uint32_t a_streamIndex, BOOL a_enable, REX::Float32 a_alpha) = 0;
		...
		virtual void VideoProcessorSetStreamLumaKey(ID3D11VideoProcessor* a_videoProcessor, std::uint32_t StreamIndex, BOOL a_enable, REX::Float32 a_lower, REX::Float32 a_upper) = 0;
		...
		virtual void VideoProcessorGetStreamAlpha(ID3D11VideoProcessor* a_videoProcessor, std::uint32_t a_streamIndex, BOOL* a_enabled, REX::Float32* a_alpha) = 0;
		...
		virtual void VideoProcessorGetStreamLumaKey(ID3D11VideoProcessor* a_videoProcessor, std::uint32_t a_streamIndex, BOOL* a_enabled, REX::Float32* a_lower, REX::Float32* a_upper) = 0;
		...
		: public IUnknown
	{
		...
		virtual std::uint32_t GetVideoDecoderProfileCount() = 0;
...
namespace REX::W32
{
	inline constexpr auto IID_ID3D11Asynchronous = IID{ 0x4B35D0CD, 0x1E15, 0x4258, { 0x9C, 0x98, 0x1B, 0x13, 0x33, 0xF6, 0xDD, 0x3B } };
	inline constexpr auto IID_ID3D11AuthenticatedChannel = IID{ 0x3015A308, 0xDCBD, 0x47AA, { 0xA7, 0x47, 0x19, 0x24, 0x86, 0xD1, 0x4D, 0x4A } };
	inline constexpr auto IID_ID3D11BlendState = IID{ 0x75B68FAA, 0x347D, 0x4159, { 0x8F, 0x45, 0xA0, 0x64, 0x0F, 0x01, 0xCD, 0x9A } };
	inline constexpr auto IID_ID3D11Buffer = IID{ 0x48570B85, 0xD1EE, 0x4FCD, { 0xA2, 0x50, 0xEB, 0x35, 0x07, 0x22, 0xB0, 0x37 } };
	inline constexpr auto IID_ID3D11ClassInstance = IID{ 0xA6CD7FAA, 0xB0B7, 0x4A2F, { 0x94, 0x36, 0x86, 0x62, 0xA6, 0x57, 0x97, 0xCB } };
	inline constexpr auto IID_ID3D11ClassLinkage = IID{ 0xDDF57CBA, 0x9543, 0x46E4, { 0xA1, 0x2B, 0xF2, 0x07, 0xA0, 0xFE, 0x7F, 0xED } };
	inline constexpr auto IID_ID3D11CommandList = IID{ 0xA24BC4D1, 0x769E, 0x43F7, { 0x80, 0x13, 0x98, 0xFF, 0x56, 0x6C, 0x18, 0xE2 } };
	inline constexpr auto IID_ID3D11ComputeShader = IID{ 0x4F5B196E, 0xC2BD, 0x495E, { 0xBD, 0x01, 0x1F, 0xDE, 0xD3, 0x8E, 0x49, 0x69 } };
	inline constexpr auto IID_ID3D11Counter = IID{ 0x6E8C49FB, 0xA371, 0x4770, { 0xB4, 0x40, 0x29, 0x08, 0x60, 0x22, 0xB7, 0x41 } };
	inline constexpr auto IID_ID3D11CryptoSession = IID{ 0x9B32F9AD, 0xBDCC, 0x40A6, { 0xA3, 0x9D, 0xD5, 0xC8, 0x65, 0x84, 0x57, 0x20 } };
	inline constexpr auto IID_ID3D11Device = IID{ 0xDB6F6DDB, 0xAC77, 0x4E88, { 0x82, 0x53, 0x81, 0x9D, 0xF9, 0xBB, 0xF1, 0x40 } };
	inline constexpr auto IID_ID3D11DeviceChild = IID{ 0x1841E5C8, 0x16B0, 0x489B, { 0xBC, 0xC8, 0x44, 0xCF, 0xB0, 0xD5, 0xDE, 0xAE } };
	inline constexpr auto IID_ID3D11DeviceContext = IID{ 0xC0BFA96C, 0xE089, 0x44FB, { 0x8E, 0xAF, 0x26, 0xF8, 0x79, 0x61, 0x90, 0xDA } };
	inline constexpr auto IID_ID3D11DepthStencilState = IID{ 0x03823EFB, 0x8D8F, 0x4E1C, { 0x9A, 0xA2, 0xF6, 0x4B, 0xB2, 0xCB, 0xFD, 0xF1 } };
	inline constexpr auto IID_ID3D11DepthStencilView = IID{ 0x9FDAC92A, 0x1876, 0x48C3, { 0xAF, 0xAD, 0x25, 0xB9, 0x4F, 0x84, 0xA9, 0xB6 } };
	inline constexpr auto IID_ID3D11DomainShader = IID{ 0xF582C508, 0x0F36, 0x490C, { 0x99, 0x77, 0x31, 0xEE, 0xCE, 0x26, 0x8C, 0xFA } };
	inline constexpr auto IID_ID3D11GeometryShader = IID{ 0x38325B96, 0xEFFB, 0x4022, { 0xBA, 0x02, 0x2E, 0x79, 0x5B, 0x70, 0x27, 0x5C } };
	inline constexpr auto IID_ID3D11HullShader = IID{ 0x8E5C6061, 0x628A, 0x4C8E, { 0x82, 0x64, 0xBB, 0xE4, 0x5C, 0xB3, 0xD5, 0xDD } };
	inline constexpr auto IID_ID3D11InputLayout = IID{ 0xE4819DDC, 0x4CF0, 0x4025, { 0xBD, 0x26, 0x5D, 0xE8, 0x2A, 0x3E, 0x07, 0xB7 } };
	inline constexpr auto IID_ID3D11PixelShader = IID{ 0xEA82E40D, 0x51DC, 0x4F33, { 0x93, 0xD4, 0xDB, 0x7C, 0x91, 0x25, 0xAE, 0x8C } };
	inline constexpr auto IID_ID3D11Predicate = IID{ 0x9EB576DD, 0x9F77, 0x4D86, { 0x81, 0xAA, 0x8B, 0xAB, 0x5F, 0xE4, 0x90, 0xE2 } };
	inline constexpr auto IID_ID3D11Query = IID{ 0xD6C00747, 0x87B7, 0x425E, { 0xB8, 0x4D, 0x44, 0xD1, 0x08, 0x56, 0x0A, 0xFD } };
	inline constexpr auto IID_ID3D11RasterizerState = IID{ 0x9BB4AB81, 0xAB1A, 0x4D8F, { 0xB5, 0x06, 0xFC, 0x04, 0x20, 0x0B, 0x6E, 0xE7 } };
	inline constexpr auto IID_ID3D11RenderTargetView = IID{ 0xDFDBA067, 0x0B8D, 0x4865, { 0x87, 0x5B, 0xD7, 0xB4, 0x51, 0x6C, 0xC1, 0x64 } };
	inline constexpr auto IID_ID3D11Resource = IID{ 0xDC8E63F3, 0xD12B, 0x4952, { 0xB4, 0x7B, 0x5E, 0x45, 0x02, 0x6A, 0x86, 0x2D } };
	inline constexpr auto IID_ID3D11SamplerState = IID{ 0xDA6FEA51, 0x564C, 0x4487, { 0x98, 0x10, 0xF0, 0xD0, 0xF9, 0xB4, 0xE3, 0xA5 } };
	inline constexpr auto IID_ID3D11ShaderResourceView = IID{ 0xB0E06FE0, 0x8192, 0x4E1A, { 0xB1, 0xCA, 0x36, 0xD7, 0x41, 0x47, 0x10, 0xB2 } };
	inline constexpr auto IID_ID3D11Texture1D = IID{ 0xF8FB5C27, 0xC6B3, 0x4F75, { 0xA4, 0xC8, 0x43, 0x9A, 0xF2, 0xEF, 0x56, 0x4C } };
	inline constexpr auto IID_ID3D11Texture2D = IID{ 0x6F15AAF2, 0xD208, 0x4E89, { 0x9A, 0xB4, 0x48, 0x95, 0x35, 0xD3, 0x4F, 0x9C } };
	inline constexpr auto IID_ID3D11Texture3D = IID{ 0x037E866E, 0xF56D, 0x4357, { 0xA8, 0xAF, 0x9D, 0xAB, 0xBE, 0x6E, 0x25, 0x0E } };
	inline constexpr auto IID_ID3D11UnorderedAccessView = IID{ 0x28ACF509, 0x7F5C, 0x48F6, { 0x86, 0x11, 0xF3, 0x16, 0x01, 0x0A, 0x63, 0x80 } };
	inline constexpr auto IID_ID3D11VertexShader = IID{ 0x3B301D64, 0xD678, 0x4289, { 0x88, 0x97, 0x22, 0xF8, 0x92, 0x8B, 0x72, 0xF3 } };
	inline constexpr auto IID_ID3D11VideoContext = IID{ 0x61F21C45, 0x3C0E, 0x4A74, { 0x9C, 0xEA, 0x67, 0x10, 0x0D, 0x9A, 0xD5, 0xE4 } };
	inline constexpr auto IID_ID3D11VideoDecoder = IID{ 0x3C9C5B51, 0x995D, 0x48D1, { 0x9B, 0x8D, 0xFA, 0x5C, 0xAE, 0xDE, 0xD6, 0x5C } };
	inline constexpr auto IID_ID3D11VideoDecoderOutputView = IID{ 0xC2931AEA, 0x2A85, 0x4F20, { 0x86, 0x0F, 0xFB, 0xA1, 0xFD, 0x25, 0x6E, 0x18 } };
	inline constexpr auto IID_ID3D11VideoDevice = IID{ 0x10EC4D5B, 0x975A, 0x4689, { 0xB9, 0xE4, 0xD0, 0xAA, 0xC3, 0x0F, 0xE3, 0x33 } };
	inline constexpr auto IID_ID3D11VideoProcessor = IID{ 0x1D7B0652, 0x185F, 0x41C6, { 0x85, 0xCE, 0x0C, 0x5B, 0xE3, 0xD4, 0xAE, 0x6C } };
	inline constexpr auto IID_ID3D11VideoProcessorEnumerator = IID{ 0x31627037, 0x53AB, 0x4200, { 0x90, 0x61, 0x05, 0xFA, 0xA9, 0xAB, 0x45, 0xF9 } };
	inline constexpr auto IID_ID3D11VideoProcessorInputView = IID{ 0x11EC5A5F, 0x51DC, 0x4945, { 0xAB, 0x34, 0x6E, 0x8C, 0x21, 0x30, 0x0E, 0xA5 } };
	inline constexpr auto IID_ID3D11VideoProcessorOutputView = IID{ 0xA048285E, 0x25A9, 0x4527, { 0xBD, 0x93, 0xD6, 0x8B, 0x68, 0xC4, 0x42, 0x54 } };
	inline constexpr auto IID_ID3D11View = IID{ 0x839D1216, 0xBB2E, 0x412B, { 0xB7, 0xF4, 0xA9, 0xDB, 0xEB, 0xE0, 0x8E, 0xD1 } };
}
