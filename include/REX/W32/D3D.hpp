...
namespace REX::W32
{
	enum D3D_CBUFFER_TYPE : std::int32_t
	{
		D3D_CT_CBUFFER = 0,
		D3D_CT_TBUFFER = 1,
	...
	enum D3D_DRIVER_TYPE : std::int32_t
	{
	...
	enum D3D_FEATURE_LEVEL : std::int32_t
	{
	...
	enum D3D_INCLUDE_TYPE : std::int32_t
	{
		D3D_INCLUDE_LOCAL = 0,
		D3D_INCLUDE_SYSTEM = 1,
		D3D10_INCLUDE_LOCAL = D3D_INCLUDE_LOCAL,
		D3D10_INCLUDE_SYSTEM = D3D_INCLUDE_SYSTEM,
		D3D_INCLUDE_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_INTERPOLATION_MODE : std::int32_t
	{
	...
	enum D3D_MIN_PRECISION : std::int32_t
	{
	...
	enum D3D_PARAMETER_FLAGS : std::uint32_t
	{
		D3D_PF_IN = 0x1,
		D3D_PF_OUT = 0x2,
		D3D_PF_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_PRIMITIVE : std::int32_t
	{
	...
	enum D3D_PRIMITIVE_TOPOLOGY : std::int32_t
	{
	...
	enum D3D_REGISTER_COMPONENT_TYPE : std::int32_t
	{
	...
	enum D3D_RESOURCE_RETURN_TYPE : std::int32_t
	{
	...
	enum D3D_SHADER_CBUFFER_FLAGS : std::uint32_t
	{
		D3D_CBF_USERPACKED = 0x1,
		D3D10_CBF_USERPACKED = D3D_CBF_USERPACKED,
		D3D_CBF_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_SHADER_INPUT_FLAGS : std::uint32_t
	{
		...
		D3D_SIF_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_SHADER_INPUT_TYPE : std::int32_t
	{
		D3D_SIT_CBUFFER = 0,
		D3D_SIT_TBUFFER = 1,
		D3D_SIT_TEXTURE = 2,
	...
	enum D3D_SHADER_VARIABLE_CLASS : std::int32_t
	{
		D3D_SVC_SCALAR = 0,
		D3D_SVC_VECTOR = 1,
		...
		D3D_SVC_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_SHADER_VARIABLE_FLAGS : std::uint32_t
	{
		...
		D3D_SVF_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_SHADER_VARIABLE_TYPE : std::int32_t
	{
		D3D_SVT_VOID = 0,
		D3D_SVT_BOOL = 1,
		D3D_SVT_INT = 2,
		...
		D3D_SVT_FORCE_DWORD = std::numeric_limits<std::int32_t>::max()
	};

	enum D3D_SRV_DIMENSION : std::int32_t
	{
	...
	enum D3D_TESSELLATOR_DOMAIN : std::int32_t
	{
	...
	enum D3D_TESSELLATOR_OUTPUT_PRIMITIVE : std::int32_t
	{
	...
	enum D3D_TESSELLATOR_PARTITIONING : std::int32_t
	{
...
namespace REX::W32
{
	...
	struct D3DMATRIX
	{
		union
		{
			struct
			{
				REX::Float32 m11, m12, m13, m14;
				REX::Float32 m21, m22, m23, m24;
				REX::Float32 m31, m32, m33, m34;
				REX::Float32 m41, m42, m43, m44;
			};
			std::array<std::array<REX::Float32, 4>, 4> m;
		};
	};
	...
	static_assert(sizeof(XMCOLOR) == 0x04);
	...
	static_assert(sizeof(XMFLOAT3) == 0x0C);
...
namespace REX::W32
{
	inline constexpr auto IID_ID3DBlob = IID{ 0xA06EB39A, 0x50DA, 0x425B, { 0x8C, 0x31, 0x4E, 0xEC, 0xD6, 0xC2, 0x70, 0xF3 } };
	inline constexpr auto IID_ID3DDestructionNotifier = IID{ 0xA06EB39A, 0x50DA, 0x425B, { 0x8C, 0x31, 0x4E, 0xEC, 0xD6, 0xC2, 0x70, 0xF3 } };
}
