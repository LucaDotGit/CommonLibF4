...
namespace REX::W32
{
	enum D3D11_CRYPTO_SESSION_KEY_EXCHANGE_FLAGS : std::uint32_t
	{
		D3D11_CRYPTO_SESSION_KEY_EXCHANGE_FLAG_NONE = 0x0
	};

	enum D3D11_FEATURE_VIDEO : std::int32_t
	{
		D3D11_FEATURE_VIDEO_DECODER_HISTOGRAM = 0
	};

	enum D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT : std::int32_t
	{
	...
	enum D3D11_VIDEO_DECODER_HISTOGRAM_COMPONENT_FLAGS : std::uint32_t
	{
...
namespace REX::W32
{
	inline constexpr auto IID_ID3D11Device4 = IID{ 0x8992AB71, 0x02E6, 0x4B8D, { 0xBA, 0x48, 0xB0, 0x56, 0xDC, 0xDA, 0x42, 0xC4 } };
	inline constexpr auto IID_ID3D11Device5 = IID{ 0x8FFDE202, 0xA0E7, 0x45DF, { 0x9E, 0x01, 0xE8, 0x37, 0x80, 0x1B, 0x5E, 0xA0 } };
	inline constexpr auto IID_ID3D11Multithread = IID{ 0x9B7E4E00, 0x342C, 0x4106, { 0xA1, 0x9F, 0x4F, 0x27, 0x04, 0xF6, 0x89, 0xF0 } };
	inline constexpr auto IID_ID3D11VideoContext2 = IID{ 0xC4E7374C, 0x6243, 0x4D1B, { 0xAE, 0x87, 0x52, 0xB4, 0xF7, 0x40, 0xE2, 0x61 } };
	inline constexpr auto IID_ID3D11VideoContext3 = IID{ 0xA9E2FAA0, 0xCB39, 0x418F, { 0xA0, 0xB7, 0xD8, 0xAA, 0xD4, 0xDE, 0x67, 0x2E } };
	inline constexpr auto IID_ID3D11VideoDevice2 = IID{ 0x59C0CB01, 0x35F0, 0x4A70, { 0x8F, 0x67, 0x87, 0x90, 0x5C, 0x90, 0x6A, 0x53 } };
}
