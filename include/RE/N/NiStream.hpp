...
namespace RE
{
	...
	public:
		...
		std::array<char, REX::W32::MAX_PATH> fileName;			   // 208
		...
		std::array<char, 260> lastLoadedRTTI;					   // 3E4
		std::uint32_t lastError;								   // 4E8
		std::array<char, 260> lastErrorMessage;					   // 4EC
		std::array<char, REX::W32::MAX_PATH> filePath;			   // 5F0
	};
