...
namespace std
{
	...
	public:
		...
		[[nodiscard]] constexpr auto format(const RE::NiRect<T>& a_value, FormatContext& a_ctx) const
		{
			using namespace std::string_view_literals;

			return format_to(a_ctx.out(), "({}, {}, {}, {})"sv, a_value.left, a_value.top, a_value.right, a_value.bottom);
		}
	};
