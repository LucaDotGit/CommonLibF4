...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::NiCullingProcess };
		inline static constexpr auto VTABLE{ VTABLE::NiCullingProcess };
		inline static constexpr auto NI_RTTI{ Ni_RTTI::NiCullingProcess };
