...
namespace RE
{
	...
	public:
		...
		virtual REX::Float32 GetElapsedTime();								   // 02 - { return 0.0_f32; }
		virtual REX::Float32 GetScale();									   // 03 - { return 1.0_f32; }
		...
		virtual REX::Float32 GetParticleAttachExtent();						   // 10 - { return 0.0_f32; }
