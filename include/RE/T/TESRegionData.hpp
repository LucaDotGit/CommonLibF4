...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::TESRegionData };
		inline static constexpr auto VTABLE{ VTABLE::TESRegionData };
		...
		// members
		bool override{ false };		// 08
		bool ignore{ false };		// 09
		std::uint8_t priority{ 0 }; // 0A
	};
