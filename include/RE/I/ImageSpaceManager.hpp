...
namespace RE
{
	...
	{
	public:
		enum class ImageSpaceEffectEnum : std::int32_t
		{
		...
		{
			static const auto SINGLETON = REL::Relocation<ImageSpaceManager**>{ ID::ImageSpaceManager::Singleton };
			return *SINGLETON;
		}
		...
		ImageSpaceBaseData* baseData;					 // 060
		...
		REX::Float32 motionBlurIntensity;				 // 1A8
		REX::Float32 motionBlurMaxBlur;					 // 1AC
