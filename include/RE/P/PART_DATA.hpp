...
namespace RE
{
	...
	public:
		...
		REX::Float32 explosionSpecialDebrisScale;  // 90
		REX::EnumSet<Flags, std::uint8_t> flags;   // 94
		std::uint8_t type;						   // 95
