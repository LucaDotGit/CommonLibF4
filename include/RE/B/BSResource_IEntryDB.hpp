...
{
	class __declspec(novtable) IEntryDB
	{
	public:
		inline static constexpr auto RTTI{ RTTI::BSResource__IEntryDB };
		inline static constexpr auto VTABLE{ VTABLE::BSResource__IEntryDB };
