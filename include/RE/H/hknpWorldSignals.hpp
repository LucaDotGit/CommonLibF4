...
namespace RE
{
	...
	public:
		...
		class ConstraintCreatedSignal
			: public hkSignal3<hknpWorld*, const hknpConstraintCinfo*, hkHandle<std::uint32_t, std::numeric_limits<std::int32_t>::max(), hknpConstraintIdDiscriminant>>
		{
		public:
		};
		...
		class ConstraintDestroyedSignal
			: public hkSignal2<hknpWorld*, hkHandle<std::uint32_t, std::numeric_limits<std::int32_t>::max(), hknpConstraintIdDiscriminant>>
		{
		public:
		};
