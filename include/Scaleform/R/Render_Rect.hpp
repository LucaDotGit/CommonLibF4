...
namespace std
{
	...
	public:
		...
		[[nodiscard]] constexpr auto format(const Scaleform::Render::Rect<T>& a_value, FormatContext& a_context) const
		{
			using namespace std::string_view_literals;

			return format_to(a_context.out(), "({}, {}, {}, {})"sv, a_value.x1, a_value.y1, a_value.x2, a_value.y2);
		}
	};
