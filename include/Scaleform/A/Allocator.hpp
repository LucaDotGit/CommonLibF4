...
namespace Scaleform
{
	...
	template <class T, std::int32_t SID>
	class AllocatorPagedGH : AllocatorBaseGH<SID>,
	...
	template <class T, std::int32_t SID>
	class AllocatorPagedLH : AllocatorBaseLH<SID>,
							 ConstructorPagedMov<T>
	{
	public:
	};
	...
	template <class T, std::int32_t SID>
	class AllocatorPagedCC : AllocatorBaseLH<SID>,
	...
	template <class T, std::int32_t SID>
	class AllocatorPagedGH_POD : AllocatorBaseGH<SID>,
	...
	template <class T, std::int32_t SID>
	class AllocatorPagedLH_POD : AllocatorBaseLH<SID>,
								 ConstructorPagedPOD<T>
	{
	public:
	};
