...
namespace Scaleform
{
	...
	{
	public:
		inline static constexpr auto RTTI{ ::RE::RTTI::Scaleform__AcquireInterface };
		inline static constexpr auto VTABLE{ ::RE::VTABLE::Scaleform__AcquireInterface };
	...
	static_assert(sizeof(AcquireInterface) == 0x08);
}
