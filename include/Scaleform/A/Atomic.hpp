...
namespace Scaleform
{
	...
	public:
		...
		constexpr AtomicValueBase() noexcept = default;
		constexpr ~AtomicValueBase() noexcept = default;

		constexpr explicit AtomicValueBase(value_type a_rhs) noexcept
			: _value(a_rhs)
		{
		}

		constexpr AtomicValueBase(const AtomicValueBase&) = delete;
		constexpr AtomicValueBase(AtomicValueBase&&) = delete;

		constexpr AtomicValueBase& operator=(const AtomicValueBase&) = delete;
		constexpr AtomicValueBase& operator=(AtomicValueBase&&) = delete;

		constexpr AtomicValueBase& operator=(value_type a_rhs) noexcept
		{
		...
		constexpr AtomicValueBase& operator++() noexcept
			requires(REX::integer<value_type>)
		{
			auto atomicValue = REX::AtomicRef(_value);
			++atomicValue;
	...
	template <class T>
	AtomicValueBase(T) -> AtomicValueBase<T>;

	extern template class AtomicValueBase<std::int8_t>;
	extern template class AtomicValueBase<std::uint8_t>;
	extern template class AtomicValueBase<std::int16_t>;
	extern template class AtomicValueBase<std::uint16_t>;
	extern template class AtomicValueBase<std::int32_t>;
	extern template class AtomicValueBase<std::uint32_t>;
	extern template class AtomicValueBase<std::int64_t>;
	extern template class AtomicValueBase<std::uint64_t>;
	extern template class AtomicValueBase<REX::Float32>;
	extern template class AtomicValueBase<REX::Float64>;
	extern template class AtomicValueBase<REX::Float128>;
	...
	template <class T>
	AtomicInt(T) -> AtomicInt<T>;

	extern template class AtomicInt<std::int8_t>;
	extern template class AtomicInt<std::uint8_t>;
	extern template class AtomicInt<std::int16_t>;
	extern template class AtomicInt<std::uint16_t>;
	extern template class AtomicInt<std::int32_t>;
	extern template class AtomicInt<std::uint32_t>;
	extern template class AtomicInt<std::int64_t>;
	extern template class AtomicInt<std::uint64_t>;
